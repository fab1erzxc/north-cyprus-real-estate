          ...
          <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+90 533 123 45 67</p>
                    <p className="text-gray-600">+90 392 815 12 34</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@ncrealestate.com</p>
                    <p className="text-gray-600">sales@ncrealestate.com</p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl shadow-lg p-8 text-white">
              ...
              <p className="mb-4 opacity-90">
                Need immediate assistance? Our emergency line is available 24/7 for urgent property matters.
              </p>
              <div className="flex items-center">
                <span className="text-2xl mr-3">🚨</span>
                <div>
                  <p className="font-semibold">Emergency Line</p>
                  <p className="text-lg">+90 533 999 88 77</p>
                </div>
              </div>
            </div>
          </div>
