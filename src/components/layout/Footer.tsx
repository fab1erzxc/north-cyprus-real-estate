      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">North Cyprus Real Estate</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Your trusted partner in finding the perfect property in North Cyprus. 
              We offer premium real estate services with a focus on luxury and quality.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 North Cyprus Real Estate. All rights reserved.
          </p>
